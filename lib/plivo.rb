...
module Plivo
  ...
  class RestAPI
    ...
    def send_digits(params={})
      call_uuid = params.delete('call_uuid')
      return request('POST', "/SendDigits/#{call_uuid}/", params)
    end
    ...
    def suspend_member(params={})
      conference_name = params.delete('conference_name')
      member_id = params.delete('member_id')
      return request('POST', "/Conference/#{conference_name}/Member/#{member_id}/Suspend/", params)
    end

    def unsuspend_member(params={})
      conference_name = params.delete('conference_name')
      member_id = params.delete('member_id')
      return request('DELETE', "/Conference/#{conference_name}/Member/#{member_id}/Suspend/", params)
    end
